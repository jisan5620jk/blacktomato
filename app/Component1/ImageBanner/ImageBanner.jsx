...
const ImageBanner = () => {
  return (
    <section className="bg-[url('/images/kPzw0Kjw-POF-Shallow-Banner-Feeling-Engine.avif')] bg-cover bg-no-repeat bg-center flex items-center justify-center h-screen">
      <div className="Container">
        <div className="">
          <picture className="flex items-center justify-center">
            <img src="/images/title-image.avif" alt="Image Banner Title" />
          </picture>
          <h3 className="font-Brandon text-lg font-semibold text-white tracking-[1.8px] text-center uppercase mt-3">
